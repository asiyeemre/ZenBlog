...
public class GetBlogsByCategoryIdQueryResult
    //Burada created ve updateat değerlerine ihtiyacımız yok uı için çalıscaz o yüzden basedtoyu miras almadık. 
{
    public Guid Id { get; set; } //basedto kullanmadıgımız için yazdık
